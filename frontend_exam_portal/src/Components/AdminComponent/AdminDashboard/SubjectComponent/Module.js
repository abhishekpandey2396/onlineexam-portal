                             ...
                             <>
                                <div id={style.content}>
                                        ...
                                        <div id={style.displayHeadingBox}> 
                                              <h2>No Module Available</h2>     
                                         </div>

                                       <div id={style.addSubjectBox}>
                                           <button onClick={handleAddSubject}>Add Module</button>
                                       </div>
                                        ...
                                        <div id={style.addBox} style={display} >   
                                           <label htmlFor="">Enter Module </label> 
                                            <input onChange={(e)=>handleInput(e)}  type="text" placeholder="Enter Module name" /> 
            ...
            <div id={style.content}>
                 ...
                 <div id={style.tableBox}>
                     <table >
                         <thead>
                            <tr>
                               <th id={style.center}>Module Name</th>
