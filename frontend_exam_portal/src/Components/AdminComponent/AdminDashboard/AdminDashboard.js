    ...
    import Module from "./SubjectComponent/Module";
    import Quiz from "./ExamComponent/Quiz";
             ...
             <div id={style.headerMenuBox}>
                ...
                <div id={style.sideMenubar}>
                         <div id={style.sideMenubarImageBox}>
                           <img src= {pic4} alt="" style={{width:150, height:150, borderRadius:80}}/>
                         </div>

                         <div id={style.sideMenubarList}>
                            <NavLink exact className={style.removeUnderline} to="/AdminDashboard/Module"> <button > <span>  Modules </span></button></NavLink>
                            <NavLink exact className={style.removeUnderline} to="/AdminDashboard/Quiz"> <button > <span>  Quiz </span></button></NavLink>
              ...
              <Switch>
                  ...
                  <Route exact path="/AdminDashboard/Module" component={Module}></Route>
                  <Route exact path="/AdminDashboard/Quiz" component={Quiz}></Route>
