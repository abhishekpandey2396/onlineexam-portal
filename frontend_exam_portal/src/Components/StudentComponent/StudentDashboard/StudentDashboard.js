                 ...
                 <div id={style.header}>
                      ...
                      <div id={style.headerHeadingBox}>
                        ...
                        <div id={style.headerMenuBox}>
                            <NavLink exact to="/StudentDashboard" style={{marginInline:10}}> <span>Module</span> </NavLink>
                            <NavLink exact to="/StudentDashboard/Result" style={{marginInline:10}}> <span>My Result</span></NavLink>
                            <NavLink onClick={logout} exact to="/StudentLogin" style={{marginInline:10}}> <span>Logout</span> </NavLink>
                       </div>
